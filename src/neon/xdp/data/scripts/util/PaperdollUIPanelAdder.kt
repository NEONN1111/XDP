...
import neon.xdp.data.scripts.util.ReflectionUtils.getFieldsMatching
import neon.xdp.data.scripts.util.ReflectionUtils.invoke
...
class PaperdollUIPanelAdder: BaseEveryFrameCombatPlugin() {
    ...
    override fun advance(amount: Float, events: MutableList<InputEventAPI>?) {
        ...
        if (hullId !in setOf("xdp_restored_sporeship", "xdp_templar")) return
