...
public class xdp_legAnimLarge implements EveryFrameWeaponEffectPlugin {

    private boolean runOnce = false, lockNloaded = false;
    private WeaponAPI torso, rShould, lShould,lTurret,rTurret, legs;
	public int frame = 7;
	...
	{		
		...
		if(frame >= 10)
			frameStr = frame+"";		
		SpriteAPI spr = Global.getSettings().getSprite("graphics/ships/derelicts/symbiant/xdp_symbiant_legs"+frameStr+".png");
